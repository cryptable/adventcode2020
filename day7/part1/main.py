...
def findBagsCanContain(bagRules, bag):
    ...
    for bagRule in bagrules:
        if isBagInBagRule(bag, bagRule.nbrAndBagKinds):
            print("--- found: {} ---".format(bagRule.bagKind))
            if not bagRule.bagKind in bagContains:
                bagContains.append(bagRule.bagKind)
            parentBagContains = findBagsCanContain(bagRules, bagRule.bagKind)
            for bagKind in parentBagContains:
                if not bagKind in bagContains:
                    bagContains.append(bagKind)
    for bagKind in bagContains:
        print(bagKind)
...
if __name__ == '__main__':
    ...
    bagContains = findBagsCanContain(bagrules, bag)

    print(len(bagrules))
    print(len(bagContains))
